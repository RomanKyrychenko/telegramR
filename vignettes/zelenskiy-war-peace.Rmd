...
```{r}
client$send_code_request("+380980018456")
```

```{r}
client$sign_in(phone = "+380980018456", code = "25521")
```
...
- These are simple text heuristics. You can refine with stemming, multilingual variants, or topic modeling.
- For more robust language handling, consider language detection and per‑language tokenization.
