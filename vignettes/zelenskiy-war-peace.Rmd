...
To keep this vignette reproducible, we load a small bundled sample dataset for the outputs shown below. The commands themselves are real and will work against Telegram once you configure credentials.
