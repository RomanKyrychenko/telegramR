...
- [`int_to_raw_le()`](https://romankyrychenko.github.io/telegramR/reference/int_to_raw_le.md)
  : Helper to convert integer to little-endian raw vector of given width
  (bytes)
...
- [`serialize_int()`](https://romankyrychenko.github.io/telegramR/reference/serialize_int.md)
  : Serialize an integer to 4 bytes little-endian.
- [`serialize_string()`](https://romankyrychenko.github.io/telegramR/reference/serialize_string.md)
